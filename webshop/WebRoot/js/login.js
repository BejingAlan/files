...
function usernameFocus() {
	...
	checkUsername.innerHTML = "请输入用户名，格式为：长度8-10的数字字母下划线字符串";
}
...
function usernameBlur() {
	...
	checkUsername.innerHTML = "<font color='green'>用户名输入正确</font>";
	return true;
}
...
function passwordBlur() {
	...
	checkPassword.innerHTML = "<font color='green'>密码输入正确</font>";
	return true;
}
