...
<body>
	...
	<div class="showall">
		...
		<div class="showbot">
			<div id="showbox">
				<img src="images/s/s1 (1).png" width="400" height="400" /> <img
					src="images/s/s1 (2).png" width="400" height="400" /> <img
					src="images/s/s1 (3).png" width="400" height="400" /> <img
					src="images/s/s1 (4).png" width="400" height="400" /> <img
					src="images/s/s1 (5).png" width="400" height="400" />
			</div>
			<!--展示图片盒子-->
			<div id="showsum">
				<!--展示图片里边-->
